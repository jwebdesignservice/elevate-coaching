    ...
    <Card className="bg-surface border-border">
      ...
      <CardContent className="flex flex-col gap-4">
        ...
        <a
          ...
          className="bg-accent text-accent-fg hover:bg-accent/90 hover:shadow-lg hover:shadow-accent/40 inline-flex h-10 items-center justify-center gap-2 rounded-md px-4 text-sm font-medium transition-colors"
        >
