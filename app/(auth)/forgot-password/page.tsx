    ...
    <Card className="bg-surface border-border">
      ...
      <CardContent className="flex flex-col gap-4">
        ...
        <a
          ...
          className="bg-accent text-accent-fg hover:bg-accent/80 hover:text-white hover:border-accent inline-flex h-10 items-center justify-center gap-2 rounded-md px-4 text-sm font-medium transition-colors"
        >
