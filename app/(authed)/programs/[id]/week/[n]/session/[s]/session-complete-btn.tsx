...
export function SessionCompleteBtn({ action, alreadyDone }: Props) {
  ...
  return (
    <Button onClick={() => startTransition(() => action())} disabled={isPending} className="bg-accent text-accent-fg hover:bg-accent/25 hover:text-white hover:border-accent w-full sm:w-auto">
