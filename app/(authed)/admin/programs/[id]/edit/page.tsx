      ...
      <div className="space-y-6 p-4 sm:p-6 lg:p-8">
        ...
        <Card className="bg-surface border-border p-6">
          ...
          <form action={metaAction} className="space-y-4">
            ...
            <div className="flex justify-end">
              <Button type="submit" className="bg-accent text-accent-fg hover:bg-accent/25 hover:text-white hover:border-accent">Save metadata</Button>
            </div>
          </form>
        </Card>
        ...
        <Card className="bg-surface border-border p-6">
          ...
          <form action={addWeek} className="flex gap-3">
            ...
            <Button type="submit" className="bg-accent text-accent-fg hover:bg-accent/25 hover:text-white hover:border-accent">
