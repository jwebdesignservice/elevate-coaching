      ...
      <div className="relative max-w-[60%]">
        ...
        <div className="flex flex-wrap gap-3">
          <Button
            ...
            className="bg-accent text-accent-fg hover:bg-accent/80 hover:text-white hover:border-accent transition-all"
          >
          ...
          {secondary && (
            <Button
              ...
              variant="outline"
              className="border-border text-text hover:border-accent transition-colors"
            >
              {secondary.label}
            </Button>
          )}
